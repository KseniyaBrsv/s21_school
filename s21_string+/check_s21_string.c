...
ck_assert_int_eq(s21_memcmp(mass1, mass2, 10), memcmp(mass1, mass2, 10));
...
ck_assert_int_eq(s21_memcmp(dest3, src3, 10), memcmp(dest3, src3, 10));
ck_assert_int_eq(s21_memcmp(src7, src8, 10), memcmp(src7, src8, 10));
ck_assert_int_eq(s21_memcmp(src2, src3, 10), memcmp(src2, src3, 10));
}
END_TEST
...
s21_size_t n3 = '\n';
size_t n4 = '\n';
ck_assert_str_eq(s21_strncat(dest1, " World!", n1), strncat(dest2, " World!", n2));
ck_assert_str_eq(s21_strncat(dest1, " World!", n3), strncat(dest2, " World!", n4));
...
int ch1 = 'l';
int ch2 = 'l';
ck_assert_str_eq(s21_strchr(src1, ch1), strchr(src2, ch2));
ck_assert_ptr_eq(s21_strchr(" ", ' '), strchr(" ", ' '));
ck_assert_str_eq(s21_strchr("0123456789", '6'), strchr("0123456789", '6'));
ck_assert_str_eq(s21_strchr("012345678", '9'), strchr("012345678", '9'));
ck_assert_str_eq(s21_strchr(dest1, '\n'), strchr(dest2, '\n'));
ck_assert_str_eq(s21_strchr(dest1, 0), strchr(dest2, 0));
ck_assert_str_eq(s21_strchr("", 'b'), strchr("", 'b'));
...
ck_assert_int_gt(s21_strncmp(src1, "Hello.", 5) * strncmp(src2, "Hello.", 5), 0);
}
END_TEST
...
char dest_strcpy_ts_1[100] = {};
char dest_strcpy_ts_2[100] = {};
ck_assert_str_eq(s21_strcpy(dest_strcpy_ts_1, "1234567890"), strcpy(dest_strcpy_ts_2, "1234567890"));
ck_assert_str_eq(s21_strcpy(dest_strcpy_ts_1, ""), strcpy(dest_strcpy_ts_2, ""));
ck_assert_str_eq(s21_strcpy(dest_strcpy_ts_1, "\0"), strcpy(dest_strcpy_ts_2, "\0"));
ck_assert_str_eq(s21_strcpy(dest_strcpy_ts_1, "Wo\n\0rld!"), strcpy(dest_strcpy_ts_2, "Wo\n\0rld!"));
ck_assert_str_eq(s21_strcpy(dest_strcpy_ts_1, "  \n\0"), strcpy(dest_strcpy_ts_2, "  \n\0"));
ck_assert_str_eq(s21_strcpy(dest_strcpy_ts_1, "\n\0sdf"), strcpy(dest_strcpy_ts_2, "\n\0sdf"));
...
ck_assert_str_eq(s21_strncpy(mass1, "01234567", 0), strncpy(mass2, "01234567", 0));
...
ck_assert_ptr_eq(s21_strstr(" 1", "as"), strstr(" 1", "as"));
...
wchar_t w = L'К';
s21_sprintf(mass1, "Make a sound %lc", w);
sprintf(mass2, "Make a sound %lc", w);
ck_assert_str_eq(mass1, mass2);
free_array(mass1, mass2);
}
END_TEST
...
setlocale(LC_ALL, "ru_RU.UTF-8");
wchar_t w = L'К';
s21_sprintf(mass1, "Make a sound %5lc v", w);
sprintf(mass2, "Make a sound %5lc v", w);
ck_assert_str_eq(mass1, mass2);
free_array(mass1, mass2);
}
END_TEST

START_TEST(s21_sprintf_wc_ts_12_3) {
setlocale(LC_ALL, "ru_RU.UTF-8");
wchar_t w = L'К';
s21_sprintf(mass1, "Make a sound %-4lc v", w);
sprintf(mass2, "Make a sound %-4lc v", w);
ck_assert_str_eq(mass1, mass2);
free_array(mass1, mass2);
}
END_TEST
...
setlocale(LC_ALL, "ru_RU.UTF-8");
wchar_t w[]= L"Папа";
s21_sprintf(mass1, "Read the word %ls v", w);
sprintf(mass2, "Read the word %ls v", w);
ck_assert_str_eq(mass1, mass2);
free_array(mass1, mass2);
}
END_TEST
...
setlocale(LC_ALL, "ru_RU.UTF-8");
wchar_t w[]= L"Папа";
s21_sprintf(mass1, "Read the word %3.11ls v", w);
sprintf(mass2, "Read the word %3.11ls v", w);
ck_assert_str_eq(mass1, mass2);
free_array(mass1, mass2);
}
END_TEST
...
setlocale(LC_ALL, "ru_RU.UTF-8");
wchar_t w[]= L"Папа";
s21_sprintf(mass1, "Read the word %110ls v", w);
sprintf(mass2, "Read the word %110ls v", w);
ck_assert_str_eq(mass1, mass2);
free_array(mass1, mass2);
}
END_TEST
...
setlocale(LC_ALL, "ru_RU.UTF-8");
wchar_t w[]= L"Папа";
s21_sprintf(mass1, "Read the word %-25ls v", w);
sprintf(mass2, "Read the word %-25ls v", w);
ck_assert_str_eq(mass1, mass2);
free_array(mass1, mass2);
}
END_TEST
...
sprintf(mass1, "%-5.4d", -123);
s21_sprintf(mass2, "%-5.4d", -123);
ck_assert_str_eq(mass1, mass2);
free_array(mass1, mass2);
}
END_TEST
...
int key_d = 0;
sprintf(mass1, "%-5.0d", key_d);
s21_sprintf(mass2, "%-5.0d", key_d);
ck_assert_str_eq(mass1, mass2);
free_array(mass1, mass2);
}
END_TEST
...
sprintf(mass1, "%-5d", 123);
s21_sprintf(mass2, "%-5d", 123);
ck_assert_str_eq(mass1, mass2);
}
END_TEST
...
sprintf(mass1, "%10.0u", 0);
s21_sprintf(mass2, "%10.0u", 0);
ck_assert_str_eq(mass1, mass2);
free_array(mass1, mass2);
}
END_TEST
...
START_TEST(sprintf_2405_2) {
    ...
    char str2[1024];
    free_array_1(str2);
    s21_sprintf(str2, "%012f", -35.8989);
    sprintf(str1, "%012f", -35.8989);
    ck_assert_str_eq(str1, str2);
} END_TEST
...
START_TEST(sprintf_2405_3) {
    ...
    char str2[1024];
    free_array_1(str2);
    s21_sprintf(str2, "%012f", 35.89);
    sprintf(str1, "%012f", 35.89);
    ck_assert_str_eq(str1, str2);
} END_TEST
...
tcase_add_test(tc1_1, s21_sprintf_wc_ts_12_3);
